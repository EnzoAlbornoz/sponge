...
public final class ServerConfiguration implements SettingsHolder {
    ...
    public static final Property<String> INSTANCE_SHARED_FOLDER = PropertyInitializer.newProperty("instance.sharedFolder", Path.of(System.getProperty("user.home")).resolve("./.sponge/storage").normalize().toString());
